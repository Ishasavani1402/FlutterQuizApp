...
import 'package:quizapplication/Screens/Rules.dart';
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text('Are you sure you want to log out?', style: GoogleFonts.poppins()),
              ],
            ),
          ),
          actions: <Widget>[
            TextButton(
              child: Text('No', style: GoogleFonts.poppins(color: kPrimaryColor)),
              onPressed: () {
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Padding(
                              ...
                              child: Card(
                                ...
                                child: ExpansionTile(
                                  leading: Icon(Icons.history_edu, color: kPrimaryColor),
                                  title: Text(
